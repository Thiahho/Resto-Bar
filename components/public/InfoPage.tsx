        ...
        <div className="bg-zinc-900/50 rounded-2xl p-5 border border-zinc-800/50 backdrop-blur-sm">
            <div className="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-sm mb-3">{businessInfo.contact.address}</p>
                    <a 
        ...
        <div className="bg-zinc-900/50 rounded-2xl p-5 border border-zinc-800/50 backdrop-blur-sm">
            <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-xs mt-1">Nuestros turnos de delivery y take-away</p>
                </div>
            </div>
        ...
        <div className="bg-zinc-900/50 rounded-2xl p-5 border border-zinc-800/50 backdrop-blur-sm">
            ...
            <div className="space-y-3">
                ...
                {businessInfo.contact.transferAlias && (
                    <div className="mt-4 p-3 bg-zinc-950 rounded-xl border border-zinc-800 flex items-center justify-between group cursor-pointer hover:border-zinc-700 transition-colors"
