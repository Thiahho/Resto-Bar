...
namespace Back.Migrations
{
    ...
    public partial class AddDineInTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // --- table_sessions ---
            // Nota: paid_at, payment_method, tip_cents se agregan en AddSessionPaymentFields
            migrationBuilder.CreateTable(
                name: "table_sessions",
                columns: table => new
                {
        ...
        {
            migrationBuilder.DropTable(name: "kitchen_tickets");
            ...
            migrationBuilder.DropTable(name: "table_sessions");
